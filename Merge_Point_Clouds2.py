...
if __name__ == "__main__":
    ...
    o3d.io.write_point_cloud("pcd_dataset/pointcloud_registered.ply", pcd_combined_registered);
    o3d.visualization.draw_geometries(pcds_down)
    ...
    o3d.io.write_point_cloud("pcd_dataset/pointcloud.ply", pcd_combined_down);
